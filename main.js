...
random=number=Math.floor((Math.random()*quick_draw_data_set.length)+1);
Ekement_of_array=quick_draw_data_set[random_number];
...
function check_sketch(){
    timer_counter++;
    document.getAnimations("timer").innerhtml = "Timer: "+timer_counter;
